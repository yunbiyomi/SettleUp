...
import { PLACE_EMOJIS, type ExpenseInfo } from "../types/expenses";
    ...
    function removeExpense(id: string) {
        setExpenses((prev) =>
            prev
                ...
                .map((expense, index) => ({ ...expense, order: index + 1 }))
        );
    }
            ...
            <>
                <li className="expenses-add expenses-add-form">
                    ...
                    <div className="expenses-add-header">
                        ...
                        <button type="button" className="expenses-add-cancel" onClick={resetForm}>
                            취소
                        </button>
                    </div>
